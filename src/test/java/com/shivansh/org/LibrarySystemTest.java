...
/**
 * Comprehensive unit tests for the Smart Library Management System.
 * Tests cover:
 *   - Password hashing (SHA-256 determinism, null safety, hash length)
 *   - Input validation (email, password, name, integer parsing)
 *   - Fine calculation (on-time, early, late, and overdue scenarios)
 *   - DTO getters/setters (Book, Member, Transaction)
 *   - Edge cases (zero-day overdue, exact due date return, large overdue)
 * 
 * @author Shivansh
 * @version 2.0
 */
public class LibrarySystemTest {
    ...
    public void testFineCalculation() {
        ...
        // Scenario 4: Book is currently overdue and not yet returned (due date was 5 days ago, no return date)
    ...
    public void testMemberDTO() {
        ...
        Member member3 = new Member(5, "Alice", "Brown", "alice@test.com", "1234567890", "pwd", "REGULAR");
    ...
    public void testTransactionDTO() {
        ...
        Transaction tx2 = new Transaction(2, 3, Date.valueOf("2026-06-01"),
                Date.valueOf("2026-06-15"), Date.valueOf("2026-06-14"), "RETURNED");
