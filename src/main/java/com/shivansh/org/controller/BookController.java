...
/**
 * Controller class for Book-related operations. Acts as the intermediary between the View
 * (Dashboard) and the Service layer, handling request delegation, exception translation, and
 * response formatting.
 *
 * <p>This follows the MVC (Model-View-Controller) architectural pattern where: - Model: Book DTO +
 * BookDao - View: Dashboard (console UI) - Controller: This class
 *
 * @author Shivansh
 * @version 1.0
 */
public class BookController {
   ...
   */
  public boolean addBook(String title, String author, String isbn, String genre, int copies)
    ...
    Book book =
        new Book(title.trim(), author.trim(), genre != null ? genre.trim() : "", copies, copies);
