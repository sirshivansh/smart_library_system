...
/**
 * Controller class for Member-related operations. Handles member registration, authentication,
 * profile management, and admin-level member lookups. Bridges the View and Service layers.
 *
 * @author Shivansh
 * @version 1.0
 */
public class MemberController {
  ...
  /**
   * Authenticates an admin user with hardcoded credentials. In a production system, this would be
   * backed by a database or LDAP.
   *
  ...
  public boolean registerMember(
    ...
    Member member =
        new Member(firstName.trim(), lastName.trim(), email.trim(), password, membershipType);
