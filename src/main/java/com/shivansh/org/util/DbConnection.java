...
/**
 * Utility class for establishing MySQL database connections and
 * initializing database tables with seed data.
 * Implements a centralized connection management strategy for the DAO layer.
 * 
 * @author Shivansh
 * @version 2.0
 */
public class DbConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/smart_library_system?createDatabaseIfNotExist=true&useSSL=false&allowPublicKeyRetrieval=true";
    private static final String USER = "root";
    private static final String PASSWORD = "root";

    /**
     * Obtains a new MySQL database connection.
     * Loads the MySQL JDBC driver and returns a Connection object.
     * 
     ...
     * Creates books, members, and transactions tables if they don't exist.
     * Inserts default book catalog (10 titles) and sample members if tables are empty.
     */
    public static void initializeDatabase() {
        ...
        try (Connection conn = getMysqlConnection();
            ...
            if (rs.next() && rs.getInt(1) == 0) {
                stmt.execute("INSERT INTO books (title, author, isbn, genre, total_copies, available_copies) VALUES " +
            ...
            if (rsMem.next() && rsMem.getInt(1) == 0) {
                ...
                stmt.execute("INSERT INTO members (first_name, last_name, email, phone, password, membership_type) VALUES " +
                        "('Shivansh', 'Mishra', 'shivnsh01@gmail.com', '9876543210', '" + hashedPass + "', 'STUDENT'), " +
                        "('Jane', 'Smith', 'jane.smith@example.com', '9876543211', '" + hashedPass + "', 'FACULTY');");
            }
