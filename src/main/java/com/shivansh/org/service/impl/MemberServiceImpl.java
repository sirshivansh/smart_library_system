...
public class MemberServiceImpl implements MemberService {
  ...
  public boolean registerMember(Member member) {
    ...
    if (!InputValidator.isValidName(member.getFirstName())
        || !InputValidator.isValidName(member.getLastName())) {
      System.out.println(
          "First name and Last name must contain only letters and spaces (2-50 chars)!");
      return false;
    }
